    ...
    <div className={cn(
      ...
      <div className="relative w-64 h-64 flex items-center justify-center">
        ...
        <div className={cn(
          ...
          stage === 'logo' ? "opacity-100 scale-100 animate-pulse-subtle" : 
          stage === 'transition' ? "opacity-80 scale-150 border-primary-400 animate-scale-up" : 
          "opacity-0 scale-200"
        )}>
          <span className={cn(
        ...
        <div className={cn(
          ...
          <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-primary-300 rounded-full animate-light-point" style={{animationDelay: '0ms'}}></div>
          <div className="absolute top-1/4 left-1/3 transform -translate-x-1/2 w-3 h-3 bg-secondary-400 rounded-full animate-light-point" style={{animationDelay: '100ms'}}></div>
          <div className="absolute top-1/4 right-1/3 transform translate-x-1/2 w-3 h-3 bg-secondary-400 rounded-full animate-light-point" style={{animationDelay: '150ms'}}></div>
          
          {/* Pontos que se transformam no corpo */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 w-6 h-6 bg-primary-500 rounded-full animate-light-point" style={{animationDelay: '200ms'}}></div>
          <div className="absolute top-1/2 left-1/3 transform -translate-x-1/2 w-2 h-2 bg-primary-400 rounded-full animate-light-point" style={{animationDelay: '300ms'}}></div>
          <div className="absolute top-1/2 right-1/3 transform translate-x-1/2 w-2 h-2 bg-primary-400 rounded-full animate-light-point" style={{animationDelay: '350ms'}}></div>
          
          {/* Pontos que se transformam nas pernas */}
          <div className="absolute bottom-1/4 left-2/5 transform -translate-x-1/2 w-3 h-3 bg-primary-600 rounded-full animate-light-point" style={{animationDelay: '400ms'}}></div>
          <div className="absolute bottom-1/4 right-2/5 transform translate-x-1/2 w-3 h-3 bg-primary-600 rounded-full animate-light-point" style={{animationDelay: '450ms'}}></div>
        </div>
        ...
        <div className={cn(
          ...
          >
            <path 
              ...
              fill="none" 
            />
            <circle cx="60" cy="30" r="20" stroke="#009dff" strokeWidth="2" fill="none" />
            <line x1="40" y1="60" x2="20" y2="70" stroke="#009dff" strokeWidth="2" />
            <line x1="80" y1="60" x2="100" y2="70" stroke="#009dff" strokeWidth="2" />
            <line x1="50" y1="120" x2="45" y2="140" stroke="#009dff" strokeWidth="2" />
            <line x1="70" y1="120" x2="75" y2="140" stroke="#009dff" strokeWidth="2" />
          </svg>
        </div>
