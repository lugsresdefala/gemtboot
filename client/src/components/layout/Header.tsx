        ...
        <div className="container-app py-6 flex-between">
          ...
          <nav className="hidden md:flex items-center space-x-2">
            <div className="flex items-center space-x-1">
              <Link href="/">
                <div className="px-4 py-2 text-indigo-100 hover:text-white bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 border border-white/5 hover:border-white/20 shadow-lg hover:shadow-indigo-500/20 text-sm font-medium">
                  Início
                </div>
              </Link>
              <Link href="/sobre">
            ...
            <SheetContent className="bg-gradient-to-br from-indigo-900 to-purple-900 border-l border-white/10 text-white">
              <div className="flex flex-col space-y-3 mt-10">
                ...
                <div onClick={() => setIsOpen(false)}>
                  <Link href="/">
                    <div className="text-indigo-100 hover:text-white bg-white/5 hover:bg-white/10 transition-all duration-300 px-4 py-4 rounded-xl block font-medium border border-white/5 hover:border-white/20 shadow-lg">
                      Início
                    </div>
                  </Link>
                </div>
