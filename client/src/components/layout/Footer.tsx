...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-[#072741] to-[#051929] text-white/80 pt-20 pb-10 overflow-hidden">
      {/* Efeitos decorativos */}
      ...
      <div className="container-app relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="md:col-span-4">
            <div className="relative p-px rounded-xl bg-gradient-to-r from-[#FFD1DC] to-[#0A3255] mb-6 inline-block">
              <div className="flex items-center space-x-3 p-4 bg-gradient-to-br from-[#062140] to-[#0A3255] rounded-xl">
                <div className="p-2 bg-gradient-to-br from-[#FFD1DC] to-[#0A3255] rounded-lg shadow-xl">
