        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Encontre aqui os contatos dos principais serviços de saúde para
              pessoas trans e informações sobre como acessar o atendimento.
            </p>
          </div>
            ...
            <Card className="border-0 shadow-lg bg-white/70 backdrop-blur-sm">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-xl">ASITT - CRT SP</CardTitle>
                </div>
                <CardDescription>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mb-2">
                      Portal oficial com informações sobre políticas de saúde
                      trans
                    </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-blue-800 text-sm space-y-1 list-disc list-inside">
                  <li>
                    Procure a UBS (Unidade Básica de Saúde) mais próxima da sua
                    residência
                  </li>
                  <li>
                    Solicite encaminhamento para os serviços especializados
                  </li>
                  <li>
                    Tenha em mãos: RG, CPF, Cartão SUS e comprovante de
                    residência
                  </li>
                  <li>
                    Não é necessário contatar diretamente o ASITT - o
                    encaminhamento deve ser feito pela UBS
                  </li>
                </ul>
              </div>
            </div>
